...
for i=1:5
    disp(Labels{i});
    disp((CH_Lab(FeatIDX1{i})'));
end


Centers_FPz = Centers;
FeatIDX05_FPz = FeatIDX1;
FeatIDX03_FPz = FeatIDX08;
...
Centers_Pz = Centers;
FeatIDX05_Pz = FeatIDX1;
FeatIDX03_Pz = FeatIDX08;
FeatIDXleast_Pz = FeatIDXleast;


%% Save
FeatIDX1 = cat(1,FeatIDX05_FPz,FeatIDX05_Pz);
FeatIDX08 = cat(1,FeatIDX03_FPz,FeatIDX03_Pz);
...
save('FeatIDXnew.mat','IDX','FeatIDX1','FeatIDX08','Centers','FeatIDXleast')
